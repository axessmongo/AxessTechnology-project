...
router.get("/email/:id/verify/:token", AxessTechnology.verifyEmail);
//reset-password;
router.post("/api/resetPassword", AxessRestPassword.resetPassword);
router.post("/passwordReset/:id/:token", AxessRestPassword.setNewPassword);
router.get("/passwordReset/:id/:token", AxessRestPassword.verifyPassword);
//dashBoard:
