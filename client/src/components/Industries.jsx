                        ...
                        <div className="col-md-8 text-white">
                            <div className="row gy-3">
                                <div className="col-6 col-md-5 col-lg-3">
                                    ...
                                    <i class="bi bi-bank2 fs-3" style={{"color":"#b5c6c4"}}></i>
                                ...
                                <div className="col-6 col-md-5 col-lg-3">
                                    ...
                                    <i class="bi bi-lungs-fill fs-3" style={{"color":"#b5c6c4"}}></i>
                                ...
                                <div className="col-6 col-md-5 col-lg-3">
                                    <div className="industries-card" data-aos='zoom-out' data-aos-duration='500'>
                                    <i class="bi bi-backpack3 fs-3" style={{"color":"#b5c6c4"}}></i>
                                ...
                                <div className="col-6 col-md-5 col-lg-3">
                                    <div className="industries-card" data-aos='zoom-out' data-aos-duration='500'>
                                    <i class="bi bi-cash-coin fs-3" style={{"color":"#b5c6c4"}}></i>
                                ...
                                <div className="col-6 col-md-5 col-lg-3">
                                    <div className="industries-card" data-aos='zoom-out' data-aos-duration='500'>
                                    <i class="bi bi-shop fs-3" style={{"color":"#b5c6c4"}}></i>
                                ...
                                <div className="col-6 col-md-5 col-lg-3">
                                    <div className="industries-card" data-aos='zoom-out' data-aos-duration='500'>
                                    <i class="bi bi-cart-plus fs-3" style={{"color":"#b5c6c4"}}></i>
                                ...
                                <div className="col-6 col-md-5 col-lg-3">
                                    <div className="industries-card" data-aos='zoom-out' data-aos-duration='500'>
                                    <i class="bi bi-building-fill-gear fs-3" style={{"color":"#b5c6c4"}}></i>
                                ...
                                <div className="col-6 col-md-5 col-lg-3">
                                    <div className="industries-card" data-aos='zoom-out' data-aos-duration='500'>
                                    <i class="bi bi-gear-wide-connected fs-3" style={{"color":"#b5c6c4"}}></i>
                                ...
                                <div className="col-6 col-md-5 col-lg-3">
                                    <div className="industries-card" data-aos='zoom-out' data-aos-duration='500'>
                                    <i class="bi bi-truck fs-3" style={{"color":"#b5c6c4"}}></i>
                                ...
                                <div className="col-6 col-md-5 col-lg-3">
                                    <div className="industries-card" data-aos='zoom-out' data-aos-duration='500'>
                                    <i class="bi bi-dice-5 fs-3" style={{"color":"#b5c6c4"}}></i>
                                ...
                                <div className="col-6 col-md-5 col-lg-3">
                                    <div className="industries-card" data-aos='zoom-out' data-aos-duration='500'>
                                    <i class="bi bi-buildings fs-3" style={{"color":"#b5c6c4"}}></i>
                                ...
                                <div className="col-6 col-md-5 col-lg-3">
                                    <div className="industries-card" data-aos='zoom-out' data-aos-duration='500'>
                                    <i class="bi bi-hand-thumbs-up fs-3" style={{"color":"#b5c6c4"}}></i>
