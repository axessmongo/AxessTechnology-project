                ...
                <div className="container">
                    <div className="row align-items-center g-5 py-5">
                        <div className="col-md-4">
                            <p className='bg-img-2'>Industries</p>
                            <h1 className='secondary-header'>Transforming Industries to Become Smarter and Safer</h1>
                            <p className='secondary-text'>At Maticz, We Tackle Some of the World's Biggest Challenges by Building Great Digital Products.</p>
                        </div>
