            ...
            <div className="layer-two min-vh-100">
                <div className="row gx-0">
                    <div className="col-md-8 bg-green-1" id='scroller'>
                        ...
                        <div className="my-5 roller-container softdev" id='softdev'>
                            ...
                            <div className=' mb-5'>
                                <div className="my-5 p-5 text-center text-white">
                                    ...
                                    <button className='gold-btn'data-aos='fade' data-aos-duration='600' data-aos-anchor-placement="bottom-bottom"><span className='d-block'>Connect with us</span> <i className="bi bi-arrow-right"></i></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-5 text-white softtest" id='softtest'>
                            <div className="">
                                <div className=" position-relative z-3">
                                    <h1 className='light-header'>
                                        Reliability
                        ...
                        <div className="p-5 roller-container text-white min-vh-100 ai" id='ai'>
                            <div className=" position-relative z-3">
                                ...
                                <div className="row align-items-center">
                                    ...
                                    <div className='col-md-4'>
                                        <img src={ai} className='w-100 animatedimg' alt="service"  data-aos='zoom-in' data-aos-duration='600'  data-aos-anchor-placement="bottom-bottom"/>
                                    </div>
                                </div>
                    ...
                    <div className="col-md-4 vh-100 bg-axess-gold-2 position-fixed end-0">
                        <div className="services-right-side d-flex h-100 justify-content-center align-items-end flex-column position-relative">
                            ...
                            <button className='service-hover-nav' data-aos='fade'>
